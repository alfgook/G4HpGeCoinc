  ...
  :Action(Gun)
{
  ...
  FileCmd->SetGuidance("This reads the CRY definition from a file. This resets the setup completely.");
  FileCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
   
  InputCmd = new G4UIcmdWithAString("/CRY/input",this);
  InputCmd->SetGuidance("CRY input lines. This appends options to the existing setup.");
